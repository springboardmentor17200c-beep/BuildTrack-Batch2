...
export class WorkersComponent {
  ...
  openAdd(): void {
    ...
    this.form.reset({ assignedProjectId: '', shiftWindow: 'General - 9 AM - 6 PM', status: 'Active' });
  ...
  openEdit(worker: Worker): void {
    ...
    this.form.reset({
      ...
      shiftWindow: worker.shiftWindow ?? 'General - 9 AM - 6 PM',
  ...
  submitAdd(): void {
    ...
    const payload = {
      ...
      contact: v.contact!,
      assignedProjectId: v.assignedProjectId || undefined,
      shiftWindow: v.shiftWindow || 'General - 9 AM - 6 PM',
