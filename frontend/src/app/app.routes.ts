  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [roleGuard],
        data: {
          roles: ['Administrator', 'Project Manager', 'Site Engineer', 'Contractor', 'Client'] as UserRole[],
        },
      },
      {
        path: 'projects/:id',
      ...
      },
      {
        ...
        canActivate: [roleGuard],
        data: { roles: ['Administrator', 'Project Manager', 'Site Engineer'] as UserRole[] },
      },
      {
        path: 'inventory',
        loadComponent: () =>
      ...
      },
      {
        ...
        canActivate: [roleGuard],
        data: { roles: ['Administrator', 'Project Manager', 'Site Engineer', 'Worker'] as UserRole[] },
      },
      {
        path: 'procurement',
        loadComponent: () =>
        ...
        canActivate: [roleGuard],
        data: { roles: ['Administrator', 'Project Manager'] as UserRole[] },
      },
      {
        path: 'reports',
        loadComponent: () =>
        ...
        canActivate: [roleGuard],
        data: { roles: ['Administrator', 'Project Manager', 'Client'] as UserRole[] },
      },
      {
        path: 'settings',
        loadComponent: () =>
        ...
        canActivate: [roleGuard],
        data: { roles: ['Administrator'] as UserRole[] },
      },
    ],
  },
